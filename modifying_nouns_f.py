...
def q_f_1a( animacy, **b):
    ...
    inf[0].append(b['основа'] + 'ы')
    inf[0].append(b['основа'] + 'е')
    if animacy:
        inf[0].append(b['основа'] + 'у')
    else:
        inf[0].append(b['основа'] + 'у')
    inf[0].append(b['основа'] + 'ой')
    inf[0].append(b['основа'] + 'е')
    # end sg
...
def q_f_7b( animacy, **b):
    ...
    if animacy:
        ...
        inf[0].append(b['основа'] + 'и́')
    if animacy:
        inf[0].append(b['основа'] + 'и́ю')
    else:
        inf[0].append(b['основа'] + 'и́ю')
    if animacy:
        inf[0].append(b['основа'] + 'иёю')
    else:
        inf[0].append(b['основа'] + 'е́ю')
    if animacy:
        inf[0].append(b['основа'] + 'ии́')
    else:
        inf[0].append(b['основа'] + 'и')
    ...
    if animacy:
        ...
        inf[0].append(b['основа'] + 'и́')
    if animacy:
        inf[0].append(b['основа'] + 'и́й')
    else:
        inf[0].append(b['основа1'] + 'й')
    if animacy:
        inf[0].append(b['основа'] + 'ия́м')
    else:
        inf[0].append(b['основа'] + 'я́м')
    if animacy:
        inf[0].append(b['основа'] + 'ии́')
    else:
        inf[0].append(b['основа'] + 'и́')
    if animacy:
        inf[0].append(b['основа'] + 'ия́ми')
    else:
        inf[0].append(b['основа'] + 'я́ми')
    if animacy:
        inf[0].append(b['основа'] + 'ия́х')
    else:
        inf[0].append(b['основа'] + 'я́х')
    # end pl
    return inf
f_funcs['7b'] = q_f_7b
