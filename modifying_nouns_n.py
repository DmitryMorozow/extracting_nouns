...
def q_n_1b(animacy, **b):
    # божество, вещество
    inf = [[], []]
    inf[0].add(b['основа'] + 'о́')
    inf[0].add(b['основа'] + 'а́')
    inf[0].add(b['основа'] + 'у́')
    inf[0].add(b['основа'] + 'о́')
    inf[0].add(b['основа'] + 'о́м')
    inf[0].add(b['основа'] + 'е́')
    # end sg
    inf[1].add(b['основа'] + 'а́')
    inf[1].add(b['основа1'])
...
def q_n_1dsVS(animacy, **b):
    ...
    inf[0].add(b['основа'] + 'е́')
    # end sg
    inf[1].add(b['основа1'] + 'ья')
    inf[1].add(b['основа1'] + 'ьев')
    inf[1].add(b['основа1'] + 'ьям')
    inf[1].add(b['основа1'] + 'ья')
    inf[1].add(b['основа1'] + 'ьями')
    inf[1].add(b['основа1'] + 'ьях')
    # end pl
...
def q_n_3as_1__2_(animacy, **b):
    ...
    inf[0].add(b['основа'] + 'у')
    inf[0].add(b['основа'] + 'о')
    inf[0].add(b['основа'] + 'ом')  # вариант b['основа1'] + 'о́м'
    inf[0].add(b['основа'] + 'е')
    # end sg
    inf[1].add(b['основа'] + 'и')
    inf[1].add(b['основа'] + 'ов')  # вариант b['основа1'] + 'о́в'
    inf[1].add(b['основа'] + 'ам')  # вариант b['основа1'] + 'а́м'
    inf[1].add(b['основа'] + 'и')
    inf[1].add(b['основа'] + 'ами')
    inf[1].add(b['основа'] + 'ах')
    # end pl
...
def q_n_3bs_1__2_(animacy, **b):
    ...
    inf[1].add(b['основа'] + 'о́в')  # вариант b['основа1'] + 'о́в'
    inf[1].add(b['основа'] + 'а́м')  # вариант b['основа1'] + 'а́м'
    inf[1].add(b['основа'] + 'и́')
    inf[1].add(b['основа'] + 'а́ми')
    inf[1].add(b['основа'] + 'а́х')
    # end pl
...
def q_n_4aV(animacy, **b):
    ...
    # end sg
    inf[1].add(b['основа'] + 'а')
    inf[1].add(b['основа'] + 'ей')  # вариант: b['основа']
    inf[1].add(b['основа'] + 'ам')
    inf[1].add(b['основа'] + 'а')
    inf[1].add(b['основа'] + 'ами')
    inf[1].add(b['основа'] + 'ах')
...
def q_n_5as__2__(animacy, **b):
    ...
    # end sg
    inf[1].add(b['основа'] + 'а')
    inf[1].add(b['основа1'])  #  b['основа'] + 'ев'
    inf[1].add(b['основа'] + 'ам')
    if animacy:
        inf[1].add(b['основа1'])  # b['основа'] + 'ев'
    else:
...
def q_n_5bs_2_(animacy, **b):
    ...
    inf = [[], []]
    inf[0].add(b['основа'] + 'цо́')
    inf[0].add(b['основа'] + 'ца́')
    inf[0].add(b['основа'] + 'цу́')
    inf[0].add(b['основа'] + 'цо́')
    inf[0].add(b['основа'] + 'цо́м')
    inf[0].add(b['основа'] + 'це́')
    # end sg
    inf[1].add(b['основа'] + 'ца́')
    inf[1].add(b['основа'] + 'цо́в')
    inf[1].add(b['основа'] + 'ца́м')
    inf[1].add(b['основа'] + 'ца́')
    inf[1].add(b['основа'] + 'ца́ми')
    inf[1].add(b['основа'] + 'ца́х')
    # end pl
...
def q_n_6as(animacy, **b):
    ...
    # ёрничанье
    inf = [[], []]
    inf[0].add(b['основа'] + 'ье')
    inf[0].add(b['основа'] + 'ья')
    inf[0].add(b['основа'] + 'ью')
    inf[0].add(b['основа'] + 'ье')
    inf[0].add(b['основа'] + 'ьем')
    inf[0].add(b['основа'] + 'ье')
    # end sg
    inf[1].add(b['основа'] + 'ья')
    inf[1].add(b['основа'] + 'ий')
...
def q_n_6bs(animacy, **b):
    ...
    # ковыльё
    inf = [[], []]
    inf[0].add(b['основа'] + 'ьё')
    inf[0].add(b['основа'] + 'ья́')
    inf[0].add(b['основа'] + 'ью́')
    inf[0].add(b['основа'] + 'ьё')
    inf[0].add(b['основа'] + 'ьём')
    inf[0].add(b['основа'] + 'ье́')
    # end sg
    inf[1].add(b['основа'] + 'ья́')
    inf[0].add(b['основа'] + 'е́й')
    inf[0].add(b['основа'] + 'ья́м')
    inf[0].add(b['основа'] + 'ья́')
    inf[0].add(b['основа'] + 'ья́ми')
    inf[0].add(b['основа'] + 'ья́х')
    # end pl
n_funcs['6*b'] = q_n_6bs
...
def q_n_6ds(animacy, **b):
    ...
    inf[1].add(b['основа1'] + 'я')
    inf[0].add(b['основа2'])
    inf[0].add(b['основа1'] + 'ям')
    inf[0].add(b['основа1'] + 'я')
    inf[0].add(b['основа1'] + 'ями')
    inf[0].add(b['основа1'] + 'ях')
    # end pl
n_funcs['6*d'] = q_n_6ds
...
def q_n_6dsV(animacy, **b):
    ...
    # end sg
    inf[1].add(b['основа1'] + 'ья')
    inf[0].add(b['основа2'] + 'ей')
    inf[0].add(b['основа1'] + 'ьям')
    inf[0].add(b['основа1'] + 'ья')
    inf[0].add(b['основа1'] + 'ьями')
    inf[0].add(b['основа1'] + 'ьях')
    # end pl
...
def q_n_7a(animacy, **b):
    # здание
    inf = [[], []]
    inf[0].add(b['основа'] + 'ие')
    inf[0].add(b['основа'] + 'ия')
    inf[0].add(b['основа'] + 'ию')
    inf[0].add(b['основа'] + 'ие')
    inf[0].add(b['основа'] + 'ием')
    inf[0].add(b['основа'] + 'ии')
    # end sg
    inf[1].add(b['основа'] + 'ия')
    inf[1].add(b['основа'] + 'ий')
    inf[1].add(b['основа'] + 'иям')
    if animacy:
        inf[1].add(b['основа'] + 'ий')
    else:
        inf[1].add(b['основа'] + 'ия')
    inf[1].add(b['основа'] + 'иями')
    inf[1].add(b['основа'] + 'иях')
    # end pl
n_funcs['7a'] = q_n_7a
...
def q_n_7b(animacy, **b):
    ...
    # мумиё
    inf = [[], []]
    inf[0].add(b['основа'] + 'иё́')
    inf[0].add(b['основа'] + 'ия́')
    inf[0].add(b['основа'] + 'ию́')
    inf[0].add(b['основа'] + 'иё́')
    inf[0].add(b['основа'] + 'иём')
    inf[0].add(b['основа'] + 'ие́')
    # end sg
    inf[1].add(b['основа'] + 'ия́')
    inf[1].add(b['основа'] + 'и́й')
    inf[1].add(b['основа'] + 'ия́м')
    inf[1].add(b['основа'] + 'ия́')
    inf[1].add(b['основа'] + 'ия́ми')
    inf[1].add(b['основа'] + 'ия́х')
    # end pl
n_funcs['7b'] = q_n_7b
...
def q_n_7bV(animacy, **b):
    ...
    inf[0].add(b['основа'] + 'ю́')
    inf[0].add(b['основа'] + 'е́')
    inf[0].add(b['основа'] + 'е́м')
    inf[0].add(b['основа'] + 'и́')
    # end sg
    inf[1].add(b['основа'] + 'я́')
    inf[1].add(b['основа1'])
    inf[1].add(b['основа'] + 'я́м')
    inf[1].add(b['основа'] + 'я́')
    inf[1].add(b['основа'] + 'я́ми')
...
def q_n_7b_(animacy, **b):
    ...
    # житиё
    inf = [[], []]
    inf[0].add(b['основа'] + 'иё')
    inf[0].add(b['основа'] + 'ия́')
    inf[0].add(b['основа'] + 'ию́')
    inf[0].add(b['основа'] + 'иё')
    inf[0].add(b['основа'] + 'ие́м')
    inf[0].add(b['основа'] + 'ие́')
    # end sg
...
def q_n_8ar(animacy, **b):
    ...
    inf = [[], []]
    inf[0].add(b['основа'] + 'я')
    inf[0].add(b['основа'] + 'ени')
    inf[0].add(b['основа'] + 'ени')
    inf[0].add(b['основа'] + 'я')
    inf[0].add(b['основа'] + 'енем')
    inf[0].add(b['основа'] + 'ени')
    # end sg
    inf[1].add(b['основа'] + 'ёна')
    inf[1].add(b['основа'] + 'ён')
    inf[1].add(b['основа'] + 'ёнам')
    inf[1].add(b['основа'] + 'ёна')
    inf[1].add(b['основа'] + 'ёнами')
    inf[1].add(b['основа'] + 'ёнах')
    # end pl
n_funcs['8°a'] = q_n_8ar
...
def q_n_8cr(animacy, **b):
    ...
    inf[0].add(b['основа'] + 'ени')
    # end sg
    inf[1].add(b['основа1'] + 'ена́')
    inf[1].add(b['основа2'])
    inf[1].add(b['основа1'] + 'ена́м')
    inf[1].add(b['основа1'] + 'ена́')
    inf[1].add(b['основа1'] + 'ена́ми')
    inf[1].add(b['основа1'] + 'ена́х')
    # end pl
n_funcs['8°c'] = q_n_8cr
