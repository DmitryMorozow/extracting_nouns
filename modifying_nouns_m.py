...
def q_m_1a__2__(animacy, **b):
    ...
    if animacy:
        ...
        inf[0].append(b['основа'] + 'а')
        inf[0].append(b['основа'] + 'у')
        inf[0].append(b['основа'])  # http://ru.wiktionary.org/wiki/Шаблон:сущ_ru_m_ina_1a((2)) is probably broken!
        inf[0].append(b['основа'] + 'ом')
        inf[0].append(b['основа'] + 'е')
        # end sg
        inf[1].append(b['основа'] + 'ы')
...
def q_m_1as(animacy, **b):
    ...
    inf = [[], []]
    inf[0].append(b['основа'])
    inf[0].append(b['основа1'] + 'а')
    inf[0].append(b['основа1'] + 'у')
    if animacy:
        inf[0].append(b['основа1'] + 'а')
    else:
        inf[0].append(b['основа'])
    inf[0].append(b['основа1'] + 'ом')
    inf[0].append(b['основа1'] + 'е')
    # end sg
    inf[1].append(b['основа1'] + 'ы')
    inf[1].append(b['основа1'] + 'ов')
...
def q_m_1b(animacy, **b):
    ...
    inf = [[], []]
    inf[0].append(b['основа'])
    inf[0].append(b['основа1'] + 'а́')
    inf[0].append(b['основа1'] + 'у́')
    if animacy:
        inf[0].append(b['основа1'] + 'а́')
    else:
        inf[0].append(b['основа'])
    inf[0].append(b['основа1'] + 'о́м')
    inf[0].append(b['основа1'] + 'е́')
    # end sg
    inf[1].append(b['основа1'] + 'ы́')
...
def q_m_1bq(animacy, **b):
    ...
    inf = [[], []]
    inf[0].append(b['основа'])
    inf[0].append(b['основа'] + 'ы́')
    inf[0].append(b['основа'] + 'е́')
    inf[0].append(b['основа'] + 'у́')
    inf[0].append(b['основа'] + 'о́й')  # вариант b['основа1'] + 'о́ю'
    inf[0].append(b['основа'] + 'е́')
    # end sg
    inf[1].append(b['основа'] + 'ы́')
    inf[1].append(b['основа1'])
...
def q_m_1cV(animacy, **b):
    ...
    inf[0].append(b['основа'] + 'е')
    # end sg
    inf[1].append(b['основа1'] + 'ья́')
    inf[1].append(b['основа2'])
    inf[1].append(b['основа1'] + 'ья́м')
    inf[1].append(b['основа2'])
    inf[1].append(b['основа1'] + 'ья́ми')
    inf[1].append(b['основа1'] + 'ья́х')
    # end pl
    return inf
m_funcs['1c^'] = q_m_1cV
...
def q_m_1c_1_V(animacy, **b):
    ...
    inf[0].append(b['основа1'] + 'а')
    inf[0].append(b['основа1'] + 'у')
    inf[0].append(b['основа'])  # http://ru.wiktionary.org/wiki/Шаблон:сущ_ru_m_ina_1c(1)^ has an error
    inf[0].append(b['основа1'] + 'ом')
    inf[0].append(b['основа1'] + 'е')
    # end sg
    inf[1].append(b['основа2'] + 'а́')
    inf[1].append(b['основа3'])
...
def q_m_2as(animacy, **b):
    ...
    inf[0].append(b['основа1'] + 'ю')
    if animacy:
        inf[0].append(b['основа1'] + 'я')
    else:
        inf[0].append(b['основа1'] + 'ь')
    inf[0].append(b['основа1'] + 'ем')
    inf[0].append(b['основа1'] + 'е')
    # end sg
    inf[1].append(b['основа1'] + 'и')
    inf[1].append(b['основа1'] + 'ей')
...
def q_m_2b(animacy, **b):
    ...
    inf = [[], []]
    inf[0].append(b['основа'] + 'ь')
    inf[0].append(b['основа1'] + 'я́')
    inf[0].append(b['основа1'] + 'ю́')
    if animacy:
        inf[0].append(b['основа1'] + 'я́')
    else:
        inf[0].append(b['основа'] + 'ь')
    inf[0].append(b['основа1'] + 'ём')
    inf[0].append(b['основа1'] + 'е́')
    # end sg
    inf[1].append(b['основа1'] + 'и́')
...
def q_m_2es(animacy, **b):
    ...
    inf[1].append(b['основа2'] + 'я́м')
    if animacy:
        inf[1].append(b['основа2'] + 'е́й')
    else:
        inf[1].append(b['основа1'] + 'и')
    inf[1].append(b['основа2'] + 'я́ми')
    inf[1].append(b['основа2'] + 'я́х')
    # end pl
    return inf
m_funcs['2*e'] = q_m_2es
...
def q_m_3ar(animacy, **b):
    ...
    inf = [[], []]
    inf[0].append(b['основа'])
    inf[0].append(b['основа2'] + 'а')
    inf[0].append(b['основа2'] + 'у')
    if animacy:
        inf[0].append(b['основа2'] + 'а')
    else:
        inf[0].append(b['основа'])
    inf[0].append(b['основа2'] + 'ом')
    inf[0].append(b['основа2'] + 'е')
    # end sg
    inf[1].append(b['основа1'] + 'и')
    inf[1].append(b['основа1'] + 'ов')
    inf[1].append(b['основа1'] + 'ам')
...
def q_m_3br(animacy, **b):
    ...
    inf[0].append(b['основа1'] + 'е́')
    # end sg
    inf[1].append(b['основа2'] + 'а')
    inf[1].append(b['основа2'])
    inf[1].append(b['основа2'] + 'ам')
    if animacy:
        inf[1].append(b['основа2'])
    else:
        inf[1].append(b['основа2'] + 'а')
    inf[1].append(b['основа2'] + 'ами')
    inf[1].append(b['основа2'] + 'ах')
    # second option
    inf[1].append(b['основа1'] + 'и́')
    inf[1].append(b['основа1'] + 'о́в')
    inf[1].append(b['основа1'] + 'а́м')
